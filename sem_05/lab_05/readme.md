...
## Вопросики
* Почему такой некрасивый выхлоп -- сначала много читателей, потом сразу все писатели, потом опять много читателей?
   
  Потому что писать можно только после освобождения очереди читателей -> пока читатели читают в очередь писателей успевают набиться все писатели. Как только они получают возможность писать, то пишут сразу все (выше приоритет)
...
4. [Лекция](https://github.com/chrislvt/OS/wiki/Лекция-10-(05.11.2020))
